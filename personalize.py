...
REPO_NAME_TO_REPLACE = "repo-template"
BASE_URL_TO_REPLACE = "https://github.com/allenai/repo-template"
...
@click.option(
    "--github-repo",
    prompt="GitHub repository (e.g. 'repo-template')",
